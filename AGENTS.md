...
3. Không sử dụng Grep,Glob để tìm kiếm code, sử dụng các tool được cung cấp bởi codebase-memory-mcp.
4. Sau khi có thay đổi về code thì hãy dùng codebase-memory-mcp để cập nhật knowledge base.

      ...
      <CardContent className="p-0">
        <Table>
          ...
          <TableBody className="divide-y divide-border-light dark:divide-border-dark">
            <TableRow className="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border-none">
              <TableCell className="px-4 py-3">
                <div className="flex flex-col">
                  <span className="text-sm font-semibold text-slate-900 dark:text-white">Premium Cotton Tee</span>
                  <span className="text-xs text-slate-500">SKU: CT-884</span>
                </div>
              </TableCell>
            ...
            <TableRow className="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border-none">
              <TableCell className="px-4 py-3">
                <div className="flex flex-col">
                  <span className="text-sm font-semibold text-slate-900 dark:text-white">Denim Jacket (M)</span>
                  <span className="text-xs text-slate-500">SKU: DJ-002</span>
                </div>
              </TableCell>
              <TableCell className="px-4 py-3 text-right">
            ...
            <TableRow className="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border-none">
              <TableCell className="px-4 py-3">
                <div className="flex flex-col">
                  <span className="text-sm font-semibold text-slate-900 dark:text-white">Leather Belt</span>
                  <span className="text-xs text-slate-500">SKU: LB-112</span>
                </div>
              </TableCell>
              <TableCell className="px-4 py-3 text-right">
            ...
            <TableRow className="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border-none">
              <TableCell className="px-4 py-3">
                <div className="flex flex-col">
                  <span className="text-sm font-semibold text-slate-900 dark:text-white">Canvas Sneakers</span>
                  <span className="text-xs text-slate-500">SKU: CS-443</span>
                </div>
              </TableCell>
              <TableCell className="px-4 py-3 text-right">
                <span className="text-sm font-bold text-orange-600 dark:text-orange-400">9</span>
                <span className="text-xs text-slate-400 block">left</span>
              </TableCell>
              <TableCell className="px-4 py-3 text-right">
                <Button variant="outline" size="sm" className="h-7 text-xs font-medium text-primary hover:text-primary-dark border-primary/30 hover:bg-primary/5">Reorder</Button>

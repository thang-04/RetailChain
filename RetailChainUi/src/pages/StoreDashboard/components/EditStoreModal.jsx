        ...
        <div aria-modal="true" className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-8" role="dialog">
            ...
            <div className="relative w-full max-w-6xl transform overflow-hidden rounded-2xl bg-card text-left shadow-lift transition-all flex flex-col h-[85vh]">
                <div className="flex items-center justify-between border-b border-[#f1f3f4] dark:border-gray-700 px-8 py-4 bg-white dark:bg-[#1e282c] shrink-0">
                    <div>
                        <h3 className="text-xl font-bold leading-6 text-[#121617] dark:text-white tracking-tight">Chỉnh sửa địa điểm cửa hàng</h3>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="rounded-xl bg-blue-50 dark:bg-blue-900/20 p-4 border border-blue-100 dark:border-blue-800">
                                    <div className="flex gap-3">
                                        ...
                                        <p className="text-xs leading-relaxed text-blue-700 dark:text-blue-300 font-medium">Các thay đổi sẽ được áp dụng ngay sau khi lưu.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <ConfirmModal
                ...
                message="Bạn có chắc chắn muốn lưu các thay đổi cho cửa hàng này không? Thông tin sẽ được cập nhật ngay lập tức."

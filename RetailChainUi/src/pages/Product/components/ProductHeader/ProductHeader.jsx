// src/pages/Product/components/ProductHeader/ProductHeader.jsx
    ...
    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
      ...
      <div className="flex gap-3">
        <Button
          ...
          variant="outline"
          className="h-11 px-5 gap-2 font-bold text-slate-900 dark:text-slate-200 border-slate-300 dark:border-slate-700"
